package net.magoriastudio.milkytales.block;
...
public class ModBlocks
{
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, MilkyTales.MOD_ID);
    public static final RegistryObject<Block> RAW_SOULSTONE_BLOCK = registerBlock("raw_soulstone_block",
